        ...
        <Card>
          ...
          <CardContent>
            {companyTicketStats.length > 0 ? (
                ...
                {companyTicketStats.map((stat) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-2xl font-bold text-gray-900">{stat.tickets}</span>
              ...
              <p className="text-gray-600 text-center py-8">No tickets issued in the selected period</p>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            {companyRevenueStats.length > 0 ? (
              ...
              <p className="text-gray-600 text-center py-8">No platform revenue in the selected period</p>
            )}
          </CardContent>
        </Card>
      </div>
